...
public class Account {
    ...
    public int register(String username, String firstName, String lastName, String email, String password, String phoneNumber) {
        //ako metoda vrati -1 to znaci da korisnik nije pravilno popunio polja na formi za registraciju
        if(!validateForm(username, firstName, lastName, email, password, phoneNumber))
            return -1;
        
        //ako metoda vrati 0 to znaci da je korisnicko ime vec zauzeto
        if(checkIfUsernameExists(username) == true)
            return 0;
        
        //ako metoda insertUserDetails vrati true, to znaci da je korisnik uspesno insertovan u bazu 
        //u tom slucaju register metoda ce da vrati 1        
        if (insertUserDetails(username, firstName, lastName, email, password, phoneNumber))
            return 1;
        else
            return -10;
        //else znaci da insertUserDetails nije vratila true vec false, sto znaci da korisnik nije insertovan u bazu
        //u tom slucaju register metoda ce da vrati -10
    }
